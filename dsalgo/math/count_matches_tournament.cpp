/**
 * LC: E: 1688. Count of Matches in Tournament
...
Example 2: Input: n = 14 Output: 13
Explanation: Details of the tournament:
...
for O(1) solution, simply for n matches there are n-1 eliminators and n-1 matches
 */
#include<iostream>
using namespace std;

//TC: Log(n) as b reduces to half in each iteration
